...
| 途径 | 可获得等级 | 说明 |
| --- | --- | --- |
| 附魔台 | 1 ~ 3 级 | 0 书架出 1 级；15 书架时三个槽位分别可出 1 / 1~3 / 3 级 |
| 附魔台（书） | 1 ~ 3 级 | 可刷出附魔书，用于铁砧合成与交易 |
| 铁砧合成 | 4 ~ 5 级 | 两本同级书合成升一级：2×3 → 4，2×4 → 5 |
| 村民图书管理员 | 1 ~ 5 级 | 与原版一致，等级随机 |
| 战利品箱 | 1 ~ 5 级 | 非宝藏附魔，可随机出现在结构战利品中 |

附魔台的成本区间按等级递增且首尾相接（`L1 [1,11]`、`L2 [11,21]`、`L3 [21,31]`、`L4 [31,41]`、`L5 [41,51]`）。15 书架时附魔台顶槽成本为 30，正好落在 3 级区间，因此**附魔台最高出 3 级**，4~5 级需靠铁砧逐步合成。
